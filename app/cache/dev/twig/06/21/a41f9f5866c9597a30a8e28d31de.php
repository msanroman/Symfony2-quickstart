    ...
    <table>
        ...
        foreach ($context['_seq'] as $context['_key'] => $context['listener']) {
            ...
            echo "</code></td>
                <td><code>";
            // line 23
            echo twig_escape_filter($this->env, $this->getAttribute($context['__internal_0621a41f9f5866c9597a30a8e28d31de_1'], "display_listener", array($this->getContext($context, 'listener'), ), "method", false), "html");
            echo "</code></td>
            </tr>
        ";
        }
        ...
        <table>
            ...
            foreach ($context['_seq'] as $context['_key'] => $context['listener']) {
                ...
                echo "</code></td>
                    <td><code>";
                // line 40
                echo twig_escape_filter($this->env, $this->getAttribute($context['__internal_0621a41f9f5866c9597a30a8e28d31de_1'], "display_listener", array($this->getAttribute($this->getContext($context, 'listeners'), $this->getContext($context, 'listener'), array(), "array", false), ), "method", false), "html");
                echo "</code></td>
                </tr>
            ";
            }
